public ReactionResult React(GasMixture mixture, IGasMixtureHolder? holder, AtmosphereSystem atmosphereSystem, float heatScale)
{
    ...
    // Capture thermal energy before mole change
    var oldThermalEnergy = atmosphereSystem.GetThermalEnergy(mixture);
    ...
    if (newHeatCapacity > Atmospherics.MinimumHeatCapacity)
        mixture.Temperature = Math.Max((oldThermalEnergy + energyReleased) / newHeatCapacity, Atmospherics.TCMB);
