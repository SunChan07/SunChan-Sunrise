...
cryo-pod-window-product-subtitle = Криогенный реанимационный блок
...
cryo-pod-window-status-injecting = Инъекция...
...
cryo-pod-window-low-pressure-warning = Опасно низкое давление. Для безопасной работы давление газа должно составлять около 100 кПа.
...
cryo-pod-window-chems-no-beaker = Колба не вставлена
cryo-pod-window-chems-empty-beaker = Колба пуста
